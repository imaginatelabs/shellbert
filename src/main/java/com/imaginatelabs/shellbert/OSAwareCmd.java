...
public class OSAwareCmd {
     ...
     * Constructor
     * @param osCmds
     *        array that specifies the command (value) against the operating system (key) it should be run against.
     */
     ...
     * @param OS
     *        for which to retrieve the operating system specific command.
